...
@Component({
  selector: 'app-customer-mission-view',
  templateUrl: './customer-mission-view.component.html',
  styleUrls: ['./customer-mission-view.component.scss'],
})

export class CustomerMissionViewComponent implements OnInit, OnDestroy {
  store: Store;
  mission: Mission;
  aisles: Aisle[];
